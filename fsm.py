...
class TocMachine(GraphMachine):
    ...
    def on_enter_photo(self, event):
        reply_token = event.reply_token
        #a=photo(t)
        send_image(reply_token,"https://scontent-tpe1-1.cdninstagram.com/v/t51.2885-15/e35/p150x150/67106275_2545056272199159_2450018728744975224_n.jpg?_nc_ht=scontent-tpe1-1.cdninstagram.com\u0026_nc_cat=103\u0026oh=b7cf4d5837dd3250af90178c55a562e3\u0026oe=5DF188B9")
        self.go_back()   
